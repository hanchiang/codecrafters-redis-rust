...
use mock::common::mock_input::{generate_ping_buffer, generate_echo_buffer, generate_incomplete_input_buffer};
...
#[test]
fn handle_connection_should_not_process_incomplete_input() {
    let mut mock_tcp_stream = MockTcpStream::new();
